...
var rooms = {
 ...
 "kitchen":{
    temperature: 18.0,
    width: 2.1, length: 3.7, height: 2.4,
 ...
 "bed1":{
    temperature: 18.0,
    width: 3.5, length: 4.3, height: 2.4,
    air_change_an_hour: 1.5,
    ...
    elements: [
      ...
      },
      {
        type:"Wall:Internal",
        orientation:"West",
        width:0.6, height:2.4,
        boundary:'landing'
      },
      {
        type:"Floor:First",
        width:3.5, height:4.3,
        boundary:'livingroom'
      },
      {
        type:"Floor:Loft",
 ...
 "bed2":{
    temperature: 18.0,
    width: 2.4, length: 3.5, height: 2.4,
 ...
 "bathroom":{
    temperature:17.0,
    width: 2.2, length: 2.4, height: 2.4,
    air_change_an_hour: 3.0,
